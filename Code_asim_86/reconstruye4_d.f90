...
!
!  Entrada: ux0r, uy0r, gx0r, gy0r, bx1r, by1r, ux0rd, uy0rd, gx0rd, gy0rd, bx1rd, by1rd 
!  Salida: ux0d, uy0d, gx0d, gy0d, bx1d, by1d 
!  
!********************************************************************
!
SUBROUTINE RECONSTRUYE4_D(ux0r, ux0rd, uy0r, uy0rd, gx0r, gx0rd, gy0r, gy0rd, bx1r, bx1rd, &
&  by1r, by1rd, ux0, ux0d, uy0, uy0d, gx0, gx0d, gy0, gy0d, bx1, bx1d, by1, by1d, &
...
!
  ...
  REAL*8, DIMENSION(nx, ny, nz) :: ux0d, uy0d, gx0d, gy0d
...
! zona veloc. de transicion inferior
  DO j=jyc+1,jyt
    ...
    DO i=1,nx
      ...
      gx0d(i, j, 1) = ramp*gx0rd(i, 1, 1)
      gx0(i, j, 1) = gx0r(i, 1, 1)*ramp
      gy0d(i, j, 1) = ramp*gy0rd(i, 1, 1)
...
! zona obs. reducida
  ...
  DO j=jyt+1,jyt+nyr-2
    ...
    DO i=1,nx
      ...
      gx0d(i, j, 1) = gx0rd(i, jred, 1)
      gx0(i, j, 1) = gx0r(i, jred, 1)
      gy0d(i, j, 1) = gy0rd(i, jred, 1)
...
! zona veloc. de transicion superior
  DO j=jyt+nyr-1,2*jyt+nyr-jyc-1
    ...
    DO i=1,nx
      ...
      gx0d(i, j, 1) = (1-ramp)*gx0rd(i, nyr, 1)
      gx0(i, j, 1) = gx0r(i, nyr, 1)*(1-ramp)
      gy0d(i, j, 1) = (1-ramp)*gy0rd(i, nyr, 1)
