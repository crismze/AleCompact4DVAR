!********************************************************************
! Guarda campos de presion para journal FDR-14
PROGRAM trayectoria3
!
   USE paramx_m 
   USE paramy_m 
   USE paramz_m 
...
!     Entrada: uxftemp, uyftemp. Salida: wzftemp
      call vortz(uxftemp,uyftemp,wzftemp,ffxp,fsxp,fwxp,ffyp,fsyp,fwyp,nx,ny,nz)
!
!     ******* Guarda campos trayectoria Inicial en dominio de asimilacion *******
      iobi=iobi+1
      call numcar (iobi,suffix)
!
!     Vorticidad      
...
!     Presion
      ...
      close(100)
!      
!     ******* Guarda campos trayectoria Asimilada en dominio de asimilacion *******
      iobf=iobf+1
      call numcar (iobf,suffix)
!
!     Vorticidad      
