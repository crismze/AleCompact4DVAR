...
!********************************************************************
!
SUBROUTINE VORTZ_B(ux, uxb, uy, uyb, wz, wzb, ffxp, fsxp, fwxp, ffyp, &
&  fsyp, fwyp, nx, ny, nz)
!
  implicit none
!
...
!
  ...
  uyb = 0.0_8
!
  CALL DERY_B(ty, tyb, ux, uxb, ffyp, fsyp, fwyp, nx, ny, nz, 1)
  CALL DERX_B(tx, txb, uy, uyb, ffxp, fsxp, fwxp, nx, ny, nz, 1)
!
END SUBROUTINE VORTZ_B
